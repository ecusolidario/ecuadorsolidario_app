class CasosController < ApplicationController
  ...
  private
    ...
    def caso_params
      params.require(:caso).permit(:titulo, :problema, :ubicacion, :youtubevideo, :user_id, imagens_attributes: [:id, :caso_id, :imagen, :_destroy], recursos_attributes: [:id, :nombre, :objetivo,:conseguidos, :_destroy])
    end
end
