class CasosController < ApplicationController
  ...
  private
    ...
    def caso_params
      params.require(:caso).permit(:titulo, :problema, :ubicacion, :youtubevideo, :user_id, imagens_attributes: [:imagen], recursos_attributes: [:id, :nombre, :objetivo,:conseguidos, :_destroy])
    end
end
